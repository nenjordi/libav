                                         ...
                                         int width)
{
    ...
    for(i = 0; i < width; i++){
        dst[i] = COMPOSE_FIDELITYiH0(b[0][i], b[1][i], b[2][i], b[3][i], dst[i],
                                         ...
                                         int width)
{
    ...
    for(i = 0; i < width; i++){
        dst[i] = COMPOSE_FIDELITYiL0(b[0][i], b[1][i], b[2][i], b[3][i], dst[i],
                                     b[4][i], b[5][i], b[6][i], b[7][i]);
    }
}

static void vertical_compose_daub97iH0(IDWTELEM *b0, IDWTELEM *b1, IDWTELEM *b2,
                                       int width)
{
    int i;
...
static void vertical_compose_daub97iH1(IDWTELEM *b0, IDWTELEM *b1, IDWTELEM *b2,
                                       int width)
{
    int i;
...
static void vertical_compose_daub97iL0(IDWTELEM *b0, IDWTELEM *b1, IDWTELEM *b2,
                                       int width)
{
    int i;
...
static void vertical_compose_daub97iL1(IDWTELEM *b0, IDWTELEM *b1, IDWTELEM *b2,
                                       int width)
{
    int i;
                                     ...
                                     int height, int stride)
{
    ...
    if(y + 5 < (unsigned)height)
        vertical_compose_l0(b[5], b[6], b[7], width);
...
static void spatial_compose97i_init2(DWTCompose *cs, IDWTELEM *buffer,
                                     int height, int stride)
{
...
static void spatial_compose53i_init2(DWTCompose *cs, IDWTELEM *buffer,
                                     int height, int stride)
{
                     ...
                     enum dwt_type type, int decomposition_count, IDWTELEM *temp)
{
    ...
    if (ff_spatial_idwt_init2(&d, buffer, width, height, stride, type,
